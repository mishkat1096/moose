...
class NoneqPartitionSobolov;
//class MooseVariableScalar;

template <>
InputParameters validParams<NoneqPartitionSobolov>();
 ...
 */
class NoneqPartitionSobolov : public Material
{
public:
  NoneqPartitionSobolov(const InputParameters & parameters);
