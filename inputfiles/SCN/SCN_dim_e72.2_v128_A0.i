...
[Mesh]
  ...
  xmax = 180
  ymax = 0
  nx = 20 # No of elements in X
  ny = 36 # No of elements in Y
  uniform_refine = 3
[]
...
[Variables]
  ...
  [./InitialCondition]
     ...
     x1 = 90 # X coordinate of the seed
     y1 = -300 # Y coordinate of the seed
...
[Materials]
  [./consts]
    ...
    prop_values = '1000 .8839 .6267 72.2 .014 .013 128 20 0.1 0.3 0.0'
